...
Dieses Dokument beschreibt die Vorprozessierung und explorative Analyse des Datensatzes, der unter [srf.ch interaktiv visualisiert](https://www.srf.ch/static/srf-data/data/2018/seco-dual-use/) und unter [diesem Link](https://www.srf.ch/static/srf-data/data/2018/seco-dual-use/data/seco_dual_use.csv) als CSV-Datei zum Download angeboten wird.
